...
import maintemple from "../images/maintemple.jpg";
...
import jungleriver from "../images/templemain.jpg";
...
const Chapter2 = () => {
  ...
  useEffect(() => {
    ...
    if (secondlaw === questions[1].answer) {
      console.log("ma");
      setwin(true)
    }
  }, [secondlaw])
  ...
  return (
      <div
          ...
          style={{backgroundImage: iscontentstate <= 10 ? (`url(${maintemple})`) : (`url(${jungleriver})`)}}
      >
        {iscontentstate == -1 ? (
            <div>
              <GameOverModal2
          ...
          {iscontentstate == 1 ? (
            <div>
              ...
              <div className="h-[200px] w-screen flex flex-row justify-around items-center">
                ...
                ></div>
                <div
                  className="h-[150px] w-[250px] bg-cover bg-center flex flex-col"
          ...
          {iscontentstate == 5 ? (
            <div className="mt-[100px]">
              ...
              <div className="h-[200px] w-screen flex flex-row justify-around items-center">
                ...
                ></div>
                <div
                    className="h-[200px] w-[300px] bg-cover bg-center flex flex-col animate-bounce"
                    style={{backgroundImage: `url(${tigerscary})`}}
                ></div>
              </div>
              <Button onClick={contentchange}>Click To Continue</Button>
          ...
          {iscontentstate == 6 ? (
            <div className="mt-[100px]">
              ...
              <div className="h-[200px] w-screen flex flex-row justify-around items-center">
                ...
                ></div>
                <div
                    className="h-[190px] w-[300px] bg-cover bg-center flex flex-col animate-bounce"
          ...
          {iscontentstate == 7 ? (
            <div className="mt-[100px]">
              ...
              <div className="h-[200px] w-screen flex flex-row justify-around items-center">
                ...
                ></div>
                <div
                  className="h-[190px] w-[250px] bg-cover bg-center flex flex-col animate-bounce"
                  style={{ backgroundImage: `url(${happytiger})` }}
                ></div>
              </div>
            </div>
          ...
          {iscontentstate == 8 ? (
            <div className="mt-[100px]">
              ...
              <div className="h-[200px] w-screen flex flex-row justify-around items-center">
                ...
                <div
                  className="h-[190px] w-[250px] bg-cover bg-center flex flex-col animate-none"
                  style={{ backgroundImage: `url(${happytiger})` }}
                ></div>
              </div>
            </div>
          ...
          {iscontentstate == 9 ? (
            <div className="mt-[100px]">
              ...
              <div className="h-[200px] w-screen flex flex-row justify-around items-center">
                ...
                ></div>
                <div
                    className={`h-[200px] w-[300px] bg-cover bg-center flex flex-col animate-none ml-[${tigerPosition}px]`}
                    style={{backgroundImage: `url(${walkingtiger})`}}
                ></div>
              </div>
              <Button onClick={contentchange}>Click To Continue</Button>
            ...
            <div className="mt-[100px]">
              <div className="h-[250px] w-screen flex flex-row justify-center items-center mb-[50px]">
                <div
                    ...
                    style={{backgroundImage: `url(${cloudleft})`}}
                >{!win && <AnimatedTyping
                    text={["We have reached the temple sanctuary!!"]}
                />}{win && <AnimatedTyping
                    text={["We won!!"]}
                />}
                ...
                <div
                    className="h-[380px] w-[480px] rounded-3xl bg-cover bg-center flex flex-col justify-center text-center items-center ml-[200px]"
                    style={{backgroundImage: `url(${brick})`}}
                >
                  <h1 className="font-bold text-white text-3xl">{questions[1].question}</h1>
                  <input className="font-bold text-white text-2xl w-[350px] bg-inherit border-2 rounded-2xl"
              ...
              <div className="h-[200px] w-screen flex flex-row justify-start items-center">
                ...
                ></div>
                <div
                  className={`h-[200px] w-[300px] bg-cover bg-center flex flex-col animate-none transition-transform hover:animate-bounce hover:translate-x-20 duration-800 ease-in-out`}
                  style={{ backgroundImage: `url(${walkingtiger})` }}
                ></div>
              </div>
            </div>
