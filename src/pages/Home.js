  ...
  return (
    <div className="h-screen">
      ...
      <div className="h-[100px] w-[1600px] rounded-3xl relative mb-7 flex-row flex justify-around">
        <div className="h-[100px] bg-[#d9d9d9] w-[66%] rounded-3xl ml-[10px] relative mb-7 flex-row flex">
          <div class="absolute inset-0 bg-inherit shadow-inner rounded-3xl flex-row flex justify-around items-center">
            ...
            <h1 className="font-semibold text-[30px]">Your Daily Quest is here !</h1>
      ...
      <div className="h-1/4 w-[70%] rounded-3xl ml-[150px] relative flex-row flex mb-5 justify-center">
       <div className="h-inherit w-[30%] rounded-3xl relative flex-row flex mr-10 cursor-pointer"  onClick={handlePhyicsClick}>
        <img src={physics} className="rounded-3xl brightness-50 object-cover w-[100%]"/>
        <p className="absolute text-white font-bold top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-3xl">Physics</p>
        </div>
      
        <div className="h-inherit w-[30%] rounded-3xl relative flex-row flex ml-10 cursor-pointer"  onClick={handleChemistryClick}>
        <img src={chemistry} className="rounded-3xl brightness-50 object-cover w-[100%]"/>
        <p className="absolute text-white font-bold top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-3xl">Chemistry</p>
        </div>
      </div>
      <div className="h-1/4 w-[70%] rounded-3xl ml-[150px] relative flex-row flex mb-5 justify-center">
      <div className="h-inherit w-[30%] rounded-3xl relative flex-row flex mr-10 cursor-pointer"  onClick={handleMathsClick}>
        <img src={maths} className="rounded-3xl brightness-50 object-cover w-[100%]"/>
        <p className="absolute text-white font-bold top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-3xl">Maths</p>
        </div>
        <div className="h-inherit w-[30%] rounded-3xl relative flex-row flex ml-10 cursor-pointer"  onClick={handleBiologyClick}>
        <img src={biology} className="rounded-3xl brightness-50 object-cover w-[100%]"/>
